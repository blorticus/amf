...
// HTTPN1N2MessageTransfer is the API callback for the Namf_Communication N1N2 Message Transfer (UE Specific) service operation
...
// HTTPN1N2MessageTransferStatus is the API callback for the Namf_Communication N1N2 Message Trasfer Status operation
